      ...
      <form action="edit-profile.php" method="post">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" name="contactNumber" value="<?= $contactNumber?>" disabled>
          </div>
          <div class="col-md-6 mb-3">
          ...
          <div class="col-md-6 mb-3">
            ...
            <select class="form-select" name="sectionId" id="sectionId" disabled>
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" name="mothersName" value="<?= $mothersName?>" disabled>
          </div>
          <div class="col-md-6 mb-3">
            <label class="form-label">Father's Name</label>
            <input type="text" class="form-control" name="fathersName" value="<?= $fathersName?>" disabled>
          </div>
          <div class="col-md-6 mb-3">
            <label class="form-label">Guardian Name</label>
            <input type="text" class="form-control" name="guardian" value="<?= $guardian?>" disabled>
          </div>
          <div class="col-md-6 mb-3">
            <label class="form-label">Parents/Guardian Contact Number</label>
            <input type="text" class="form-control" name="parentsNum" value="<?= $parentsNum?>" disabled>
          </div>
        </div>
