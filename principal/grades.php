            ...
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content">
                    <div class="modal-body text-center p-lg-4">
                        ...
                        <button type="button" class="btn btn-<?= $_SESSION['modalType'] === 'success' ? 'success' : 'danger'; ?> btn-lg mt-3" data-bs-dismiss="modal" onclick="window.location.href='<?= $_SESSION['redirectUrl'] ?? 'grades.php'; ?>'">OK</button>
                    </div>
                </div>
            </div>
        </div>
