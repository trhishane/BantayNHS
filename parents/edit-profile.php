...
<main id="main" class="main">
    ...
    <div class="container-fluid">
        <div class="card mb-5">
            <div class="card-body">
                <h5 class="mt-2 mb-1 text-center">Edit Profile Information</h5>
                <form action="crud/update-profile.php" method="post">
                    ...
                    <input type="text" class="form-control" value="<?= $parentId ?>" disabled>
                    </div>
                    <div class="row mb-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" id="birthDate" name="birthDate" class="form-control" value="<?= htmlspecialchars($birthDate) ?>"  onchange="calculateAge();" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Gender</label>
                            <input type="text" class="form-control" name="sex" value="<?= htmlspecialchars($sex) ?>" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Age</label>
                            <input type="text" class="form-control" id="age" name="age" value="<?= htmlspecialchars($age) ?>" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Contact Number</label>
                            <input type="text" class="form-control" name="contactNumber" value="<?= htmlspecialchars($contactNumber) ?>" required>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <?php if (!empty($students)): ?>
                            <?php foreach ($students as $student): ?>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" value="<?= htmlspecialchars($student['studentId']) ?>" readonly>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Student Name</label>
                                    <input type="text" class="form-control" value="<?= htmlspecialchars($student['firstName'] . ' ' . $student['middleName'] . ' ' . $student['lastName']) ?>" readonly>
                                </div>
                            <?php endforeach; ?>
                        <?php else: ?>
