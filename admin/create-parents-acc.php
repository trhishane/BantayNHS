    ...
    if (in_array($fileExtension, $allowedFileType)) {
        ...
        foreach ($sheetData as $index => $row) {
            ...
            $sql = "INSERT INTO tblusersaccount (userId, firstName, middleName, lastName, suffixName, username, password, role, email) 
                    VALUES ('$userId', '$firstName', '$middleName', '$lastName', '$suffixName', '$username', '$hashedPassword', 'Parent', '$email')";
...
<main id="main" class="main">
    ...
    <div class="d-flex justify-content-center">
        <div class="card w-75 p-3">
            <div class="card-body">
            <h5>Create Parent Account</h5>
                    <p>Account Details</p>
                    <div class="d-flex justify-content-center">
                        <form action="create-parents-acc.php" method="POST" class="w-75">
                            <div class="mb-3">
                    ...
                    <hr>
                <h5>Create Multiple Parents Accounts</h5>
                <form action="create-parents-acc.php" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
