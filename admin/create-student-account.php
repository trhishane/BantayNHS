    ...
    if (in_array($fileExtension, $allowedFileType)) {
        ...
        foreach ($sheetData as $index => $row) {
            ...
            $sql = "INSERT INTO tblusersaccount (userId, firstName, middleName, lastName, suffixName, username, password, role, email) 
                    VALUES ('$userId', '$firstName', '$middleName', '$lastName', '$suffixName', '$username', '$hashedPassword', 'Student', '$email')";
...
// Also add the code for creating a teacher account manually
    ...
    <div class="d-flex justify-content-center">
        <div class="card w-75 p-3">
            ...
            <h5>Create Student Account</h5>
                    <p>Account Details</p>
                    <div class="d-flex justify-content-center">
                        <form action="create-student-account.php" method="POST" class="w-75">
                            <div class="mb-3">
                    ...
                    <hr>
                <h5>Create Multiple Students Accounts</h5>
                <form action="create-student-account.php" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
