    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="view-grades.php" style="text-decoration: none;">Grades</a></li>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="text-left mt-4">
                <a href="manage-grades.php" class="btn btn-secondary"><i class="bi bi-arrow-left me-1"></i>Back</a>
            </div>
        </div>
    </div>
</main>
