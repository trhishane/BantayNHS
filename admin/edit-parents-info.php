                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" name="firstName" class="form-control" value="<?php echo $parent['firstName']; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="middleName" class="form-label">Middle Name</label>
                            <input type="text" name="middleName" class="form-control" value="<?php echo $parent['middleName']; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="lastName" class="form-label">Last Name</label>
                            <input type="text" name="lastName" class="form-control" value="<?php echo $parent['lastName']; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="text" name="email" class="form-control" value="<?php echo $parent['email']; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="username" class="form-label">Username</label>
                            <input type="text" name="username" class="form-control" value="<?php echo $parent['username']; ?>" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="password" class="form-label">Password</label>
                            <input type="text" name="password" class="form-control" value="<?php echo $parent['password']; ?>" disabled>
                        </div>
                        <a href="manage-parents.php" class="btn btn-secondary"><i class="fa-solid fa-arrow-left me-2"></i>Back</a>
            ...
            <script>
                function resetForm() {
                    <?php if ($modalType === 'success') { ?>
                        window.location.href = "manage-parents.php";
                    <?php } ?>
                }
