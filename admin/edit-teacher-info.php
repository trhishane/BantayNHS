...
if (isset($_GET['userId'])) {
    ...
    if (mysqli_num_rows($query_run) > 0) {
        $teacher = mysqli_fetch_assoc($query_run);
                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="middleName" class="form-control" value="<?php echo $teacher['middleName']; ?>">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="username" class="form-control" value="<?php echo $teacher['username']; ?>" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="password" class="form-label">Password</label>
                            <input type="text" name="password" class="form-control" value="<?php echo $teacher['password']; ?>" disabled>
                        </div>
                        <a href="manage-teachers.php" class="btn btn-secondary"><i class="fa-solid fa-arrow-left me-2"></i>Back</a>
