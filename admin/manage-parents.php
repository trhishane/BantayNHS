...
<title>Parents | Student Portal</title>
...
$sql = "SELECT * FROM tblusersaccount WHERE role = 'Parent' AND archived = 0";
if ($searchQuery) {
...
$totalRecordsQuery = "SELECT COUNT(*) as total FROM tblusersaccount WHERE role = 'Parent' AND archived = 0";
if ($searchQuery) {
  ...
  <div class="card-body">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-end mb-2">
      ...
      <div class="d-flex flex-column flex-md-row align-items-end">
        ...
        <a href="create-parents-acc.php" class="btn btn-primary ms-md-1 mt-1 mt-md-0">
          ...
          <?php if (mysqli_num_rows($result) > 0): ?>
            ...
            <?php while ($row = mysqli_fetch_assoc($result)): ?>
              ...
              <td style="width: 150px;">
                  <a href='edit-parents-info.php?userId=<?= $userId ?>' class='btn btn-success btn-sm mb-1' title='Edit Account'>
