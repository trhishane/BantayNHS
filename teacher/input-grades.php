...
<main id="main" class="main">
    ...
    <div class="card mb-5">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="card-title">Input Grades</h5>
            </div>
            <div class="d-flex justify-content-center align-items-center">
                <div class="w-50">
                    <form id="inputGradesForm" action="manage-grades.php" method="POST">
                        <div class="mb-3 text-center">
                            <label for="inputSubjectSelect" class="form-label">Choose a subject handle: </label>
                            <select id="inputSubjectSelect" class="form-select w-100 mx-auto d-block" name="subject" required onchange="this.form.submit()">
    ...
    <div class="card mb-5">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-center align-items-center">
                <div class="w-50">
                    <form id="viewGradesForm" action="view-grades.php" method="POST">
                        <div class="mb-3 text-center">
                            <label for="viewSubjectSelect" class="form-label">Choose a subject handle: </label>
                            <select id="viewSubjectSelect" class="form-select w-100 mx-auto d-block" name="subject" required onchange="this.form.submit()">
                                <option value="">Select a subject</option>
                                <?php foreach ($assignedSubjects as $subject): ?>
                                    <option value="<?php echo htmlspecialchars($subject['subjectName']) . '_' . htmlspecialchars($subject['sectionName']); ?>">
                                        <?php 
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-lg-4">
                    ...
                    <button type="button" class="btn btn-<?php echo $_SESSION['modalType'] === 'success' ? 'success' : 'danger'; ?> btn-lg mt-3" data-bs-dismiss="modal" onclick="window.location.href='<?php echo $_SESSION['redirectUrl'] ?? 'input-grades.php'; ?>'">OK</button>
                </div>
            </div>
        </div>
    </div>
