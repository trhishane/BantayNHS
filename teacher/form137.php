<?php
$page_title = "Form 137 (Student Permanent Record)";
$currentPage = "form137";
...
if (!empty($students) && isset($students[0])) {
    echo "<!-- Available columns: " . implode(", ", array_keys($students[0])) . " -->";
}
?>
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <br/><br/>
                    <h1>Form 137 (Student Permanent Record)</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="generate_form137.php" method="GET" target="_blank">
                                ...
                                <button type="submit" class="btn btn-primary">Generate Form 137</button>
                            </form>
                        </div>
                    </div>
                </div>
